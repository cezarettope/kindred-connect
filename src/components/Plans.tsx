...
const plans: Plan[] = [
  {
    ...
    badge: null,
    highlight: false,
    features: ["Treinos básicos", "Acesso ao sistema", "Plano alimentar padrão"],
    url: URL_ESSENCIAL,
    triggersUpsell: true,
  ...
  },
  {
    ...
    badge: "Premium",
    highlight: false,
    features: ["Tudo do plano essencial", "Ajustes básicos", "Direcionamento estratégico"],
    url: URL_CONSULTA,
    triggersUpsell: true,
